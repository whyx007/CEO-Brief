...
$proc = Start-Process -FilePath $pythonExe -ArgumentList '-m uvicorn app:app --host 0.0.0.0 --port 8000' -WorkingDirectory $root -RedirectStandardOutput $outLog -RedirectStandardError $errLog -PassThru -WindowStyle Hidden
